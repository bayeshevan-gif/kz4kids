...
"[project]/app/api/levels/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireUser"])();
    if (error) return error;
    const levels = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].learningLevel.findMany({
        orderBy: [
            {
                number: "asc"
            },
...
async function POST(req) {
    ...
    if (!name) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Название уровня обязательно"
        }, {
            status: 400
        });
    }
    const maxOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].learningLevel.aggregate({
        _max: {
            order: true
        }
    });
    const level = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].learningLevel.create({
        data: {
            name,
            nameKz,
            emoji,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07t2tub._.js.map